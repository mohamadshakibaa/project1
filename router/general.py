...
@router.get("/project1/", response_model= Items, tags=[" List"])

async def create_exclude(item_id : Literal["labaniat","mavad_shoyande","mavad_behdashti", "mavad_qzaei", "tanaqolat" , "drink"]):
